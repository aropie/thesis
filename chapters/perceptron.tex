...
\begin{figure}[h]
  \includegraphics[scale=0.5]{activation}
  \centering
...
\subsection{Él perceptrón multicapa}
...
Inicialmente, a cada neurona se le asigna un peso aleatorio. Dada la arquitectura
