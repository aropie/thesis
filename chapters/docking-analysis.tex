...
4EIL\_CB3\_A & 1                                                                             & -10.2        & 3.08  \\
4EIL\_CB3\_A & 2                                                                             & -10.0         & 3.02  \\
4EIL\_CB3\_A & 3                                                                             & -9.8         & 3.02  \\
4EIL\_CB3\_A & 4                                                                             & -9.5         & 1.31  \\
4EIL\_CB3\_A & 5                                                                             & -9.3         & 3.0  \\ \hline
\end{tabular}
\caption{Extracto de la tabulación de poses contra RMSD a la
  ...
  tiene el menor RMSD. El formato de nombre de las poses es
  \{compuesto\}\_\{ligando acoplado\}\_\{cadena\}.}
\label{tab:poses}
\end{table}
